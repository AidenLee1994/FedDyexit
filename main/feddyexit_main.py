...
from node.feddyexit.server_node import Server_Node
from node.feddyexit.client_node import Client_Node
...
def main():
    ...
    global_model.set_exit_threshold(args.defdyexit_exit_threshold)
    ...
    for i in range(1,args.client_num_in_total):
        ...
        client_list[i].init_binarize_mask()
