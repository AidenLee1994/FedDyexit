...
from node.ditto.server_node import Server_Node
from node.ditto.client_node import Client_Node
...
def main():
    ...
    for round in range(args.comm_round):
        ...
        for idx in selected_indx:
            client = client_list[idx]
            client.set_model_all_params(server_params)
